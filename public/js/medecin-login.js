// Gestion de la connexion médecin
document.getElementById('medecinLoginForm').addEventListener('submit', async (e) => {
  e.preventDefault();
  ...
  try {
    const response = await fetch('/api/auth/medecin/login', {
      method: 'POST',
      headers: {
    ...
    localStorage.setItem('user_role', 'medecin');
